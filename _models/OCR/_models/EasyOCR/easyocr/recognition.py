...
def get_recognizer(recog_network, network_params, character,\
    ...
    if recog_network == 'generation1':
        model_pkg = importlib.import_module(".easyocr.model.model", package="_models.OCR._models.EasyOCR")
    elif recog_network == 'generation2':
        model_pkg = importlib.import_module(".easyocr.model.vgg_model",  package="_models.OCR._models.EasyOCR")
    else:
