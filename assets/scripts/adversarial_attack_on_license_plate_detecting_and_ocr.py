# -*- coding: utf-8 -*-
"""Adversarial Attack on License Plate Detecting and OCR.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bGjqk-0HHIVrNMVHREz7eHESsylcUm3Y
...
imgs_folder = 'LP_detection/images/train'
labels_folder = 'LP_detection/labels/train'
...
yolo_LP_OCR.eval()
if len(list_plates) == 0:
    lp, bbox = read_plate_and_bboxes(yolo_LP_OCR, img)
    if lp != "unknown":
    ...
    for plate in list_plates:
        ...
        for cc in range(0,2):
            for ct in range(0,2):
                lp, bboxes = read_plate_and_bboxes(yolo_LP_OCR, utils_rotate.deskew(crop_img, cc, ct))
                if lp != "unknown":
                    list_read_plates.append(lp)
...
img_files = ['/content/LP_detection/images/train/CarLongPlate101.jpg', '/content/LP_detection/images/train/CarLongPlate102.jpg']
...
def display_images(img_path1, img_path2, plates):
...
att_img_path = '/content/attack_ocr_detect_results/images/train/CarLongPlate101.jpg'
original_path = '/content/LP_detection/images/train/CarLongPlate101.jpg'
...
display_images(att_img_path, original_path, plates)
